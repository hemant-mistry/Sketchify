"""
Django settings for sketchifybackend project.
...
SECRET_KEY = 'django-insecure--ahvd=^(2#3vq8sp$pht#ul23jzx*_9q0pjap%4u@z0xoa9ci5'
...
ROOT_URLCONF = 'sketchifybackend.urls'
...
ASGI_APPLICATION = 'sketchifybackend.wsgi.application'
